let viewProducts ={
            ...
            viewProducts.tblProducts.table = $('#tblProducts').DataTable({
                ...
                columns:[
                    ...
                    {data: 'price' ,render: function ( data, type, row ){
                        return '<a href="#" class="edit-price" data-backdrop="static" data-dismiss="modal" data-toggle="modal" data-target="#modal-save-stock" data-newproduct="false">'+row.price+'</a>'
                    }},
                    {data: 'stock' ,render: function ( data, type, row ){
                        return '<a href="#" class="edit-price" data-backdrop="static" data-dismiss="modal" data-toggle="modal" data-target="#modal-save-stock" data-newproduct="false">'+row.stock+'</a>'
                    }},
    ...
    init: function(){
        ...
        viewProducts.queryContainer.find('#dpStore,#dpCategory').change(function(){
            viewProducts.tblProducts.reload();
        });
    }
}
