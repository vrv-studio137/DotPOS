        ...
        init:function () {
            ...
            viewproductcategory.tblCategory.table = viewproductcategory.modal.find('#tblProductCategory').DataTable({
                    ...
                    {data:'categoryid',render: function ( data, type, row ){
                            ...
                            return '<div class="">\
                                ...
                                <div class="dropdown-menu">\
                                    ...
                                    <a href="#" class="dropdown-item view-history" data-backdrop="static" data-dismiss="modal" data-toggle="modal" data-target="#modal-category-history">History</a>\
                                </div>\
                            </div>';
                        }
                    },
                ...
                initComplete:function(settings, json) {
                    ...
                    viewproductcategory.modal.find('#tblProductCategory tbody').on('click', '.view-history', function () {
                        var row = viewproductcategory.tblCategory.table.row($(this).closest('tr'));
                        var data = row.data();

                        viewcategoryhistory.params.categoryid = data.categoryid;
                    });
                }
            });
