    ...
    init: function(){
        ...
        saveproduct.modal.on('show.bs.modal', function () {
            ...
            if(saveproduct.params.productid != 0){
                ...
                saveproduct.modal.find('#btnSaveAddMore').hide();
                saveproduct.modal.find('#btnSave').show();

            }else{
                saveproduct.modal.find('#btnSaveAndUpdateStock').show();
                saveproduct.modal.find('#btnSaveAddMore').show();
                saveproduct.modal.find('#btnSave').hide();
        ...
        //Submit
        saveproduct.modal.find('#btnSaveAddMore').on('click',function(e){
            ...
            if (saveproduct.modal.find('#formSaveProduct')[0].checkValidity() === false) {
                ...
                if(saveproduct.params.productid == 0){
                    ...
                    util.confirmDialog('Confirmation','Save changes for this product?',function(){
                        saveproduct.save(3);
                    })
                }
